...
/*    WHERE pt.navigation_start IS NOT NULL AND pt.navigation_start > 0
      ...
      AND DATE_PART('day', pt.root_tstamp - (TIMESTAMP 'epoch' + pt.response_end/1000 * INTERVAL '1 second ')) < 365
      AND DATE_PART('day', pt.root_tstamp - (TIMESTAMP 'epoch' + pt.unload_event_start/1000 * INTERVAL '1 second ')) < 365
      AND DATE_PART('day', pt.root_tstamp - (TIMESTAMP 'epoch' + pt.unload_event_end/1000 * INTERVAL '1 second ')) < 365*/
